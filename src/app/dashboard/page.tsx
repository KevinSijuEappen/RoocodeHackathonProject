...
import { Settings, MapPin, AreaChart, LogIn, UserPlus, LayoutDashboard, MessageSquare } from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center text-white">
          <AreaChart className="w-12 h-12 mx-auto mb-4 animate-pulse" />
      ...
      <SignedOut>
        <div className="min-h-screen bg-gray-900 text-white flex items-center justify-center p-4">
          <div className="max-w-md w-full text-center">
            <h1 className="text-5xl font-bold mb-4">Redirecting to login...</h1>
          </div>
        </div>
      </SignedOut>
    );
          ...
          <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              <div className="flex items-center gap-4">
                <AreaChart className="w-8 h-8 text-blue-400" />
                <h1 className="text-2xl font-bold">Area Infograph</h1>
              </div>
              <div className="flex items-center gap-4">
